  ...
  var dtConfig = {
    ...
    "ajax": {
      ...
      "dataSrc": function (json) {
        return json.data.block_transactions;
      }
    },
    "columns": []
  };
  ...
  dtConfig.columns.unshift(
    {
      ...
      render: function(data, type, full, meta){
        return '<div class="text-truncate d-inline-block addressCellMaxWidth"><img src="https://dummyimage.com/400x400/22aaee/fff.png" class="tokenIcon" /><span class="tokenDetailsColora84 ">'+data.contract_address+'</span></div>';
      },
      width: '20%',
    },
    {
    ...
    },
    {
      ...
      data: null,
      render: function(data, type, full, meta){
        return '<div class=" text-truncate d-inline-block addressCellMaxWidth"><span class="tokenDetailsColora84"> From </span><span class="default_bright_blue">'+ data.t_from+' </span></div>';
      },
      width: '16%',
    },
    {
    ...
    },
    {
      ...
      data: null,
      render: function(data, type, full, meta){
        return '<div class=" text-truncate d-inline-block addressCellMaxWidth"><span class="tokenDetailsColora84"> To </span><span class="default_bright_blue">'+ data.t_to +' </span></div>';
      },
      width: '16%',
    }
  );
