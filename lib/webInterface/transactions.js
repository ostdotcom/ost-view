...
var transactions = module.exports = function(config){
	  this._utilityInteractInstance = new utility_interact(coreConstants.OSTE_GETH_UTILITY_RPC_PROVIDER);
...
transactions.prototype = {
	...
	getRecentTransactions : function(page) {
	    ...
	    return new Promise(function(resolve, reject){
			...
			dbInteract.getRecentTransactions(page,recentTransactionsPageSize)
	...
	,getPendingTransactions : function(page){
		...
		return new Promise(function(resolve, reject){
	    	...
	    	var startIndex =  (page * recentTransactionsPageSize);

			for (var i = startIndex; i < (startIndex+recentTransactionsPageSize); i++){
