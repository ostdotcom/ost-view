	...
	*@return{Promise}
	...
	getAddressBalance : function (hash) {
		...
		return new Promise(function(resolve, reject){
			...
			var utilityInteractInstance = new utilityInteractInstance(coreConstants.OSTE_GETH_UTILITY_RPC_PROVIDER)


			return utilityInteractInstance._getBalance(hash, stContractInteract)
				.then(function(response){
					resolve (response);
				})
				.catch(function(reason){
