 ...
 * @constructor
 * 
 * @param  {String} webRpcUrl
 * @param  {Object} chainDBConfig
 */
...
address.prototype = {
	...
	/**
	 * This method servers availabel balance of address
	 * @param {String} hash it is a hash of address for which balance needs to fetch
	 * @return {Promise}
	 */
