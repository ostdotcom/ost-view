    ...
    return Promise.all(promiseArray)
        .then(function(promiseResponse){
            ...
            promiseResponse.forEach(function(data){
                ...
                total_transactions.push({transaction_number :oThis.checkNull(val), timestamp: timestamp});
                ...
                total_transfers.push({transfers_value :oThis.checkNull(val), timestamp: timestamp});
