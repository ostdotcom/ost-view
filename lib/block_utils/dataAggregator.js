...
DataAggregator.prototype.addGraphForLastYear = function (contractHash, timeId) {
  ...
  return this.addGraph({
    contractHash: contractHash,
    timeId: moment((timeId*1000) + (quantum*1000)).startOf('month').unix(),
    quantum: quantum,
    graphSize: 12,
    graphScale: 'Year'
  });
...
DataAggregator.prototype.addGraphForLastDay = function (contractHash, timeId) {
  ...
  return this.addGraph({
    contractHash: contractHash,
    timeId: moment((timeId*1000) + (quantum*1000)).startOf('hour').unix(),
    quantum: quantum,
    graphSize: 24,
    graphScale: 'Day'
  });
...
DataAggregator.prototype.addGraphForLastHour = function (contractHash, timeId) {
  ...
  return this.addGraph({
    contractHash: contractHash,
    timeId: moment((timeId*1000) + (quantum*1000)).startOf('minute').unix(),
    quantum: quantum,
    graphSize: 12,
    graphScale: 'Hour'
  });
...
DataAggregator.prototype.addGraphForLastWeek = function (contractHash, timeId) {
  ...
  return this.addGraph({
    contractHash: contractHash,
    timeId: moment((timeId*1000) + (quantum*1000)).startOf('day').unix(),
    quantum: quantum,
    graphSize: 7,
    graphScale: 'Week'
  });
