        ...
        .then(function (transactions) {
            ...
            return Promise.all(promiseArray)
                .then(function( internalTransactions ) {
                    ...
                    return oThis.syncUpContractMap()
                        .then(function(){
    ...
    return oThis.dbInteract.getTransactionType(txnHashes)
        .then(function(transactionsTypes) {
            ...
            internalTransactions.forEach(function(internalTxn) {
                ...
                obj.branded_token_id = oThis.contractIdMap[internalTxn.contract_address]
            });
...
DataAggregator.prototype.setUpCacheData = function () {
    ...
    this.dbInteract.getBrandedTokenDetails()
        .then(function(btResult){
            ...
            config.getChainConfig(oThis.chainId).branded_token_addresses.forEach(function(contractHash){
                promiseArray.push(oThis.insertGraphDataOfCompany(contractHash));
            });
...
/**
 *  To sync up contractId Map
 */
DataAggregator.prototype.syncUpContractMap = function() {
    var oThis = this;
    return this.dbInteract.getBrandedTokenDetails()
        .then(function(btResult){
            btResult.forEach(function(contractHash){
                if (oThis.contractIdMap[contractHash.contract_address] == undefined) {
                    oThis.contractIdMap[contractHash.contract_address] = contractHash.id;
                }
            });
            return Promise.resolve(btResult);
        });
