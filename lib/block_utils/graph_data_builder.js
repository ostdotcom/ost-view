...
GraphDataBuilder.prototype.processTimeFrame = async function (timeFrame) {
  ...
  try {
    ...
    if (cronData[timeFrame].timestamp !== 0) {
    ...
    // console.log("DEBUG...", lastTimeId, graphTimeObj.startTimestamp);
    ...
    while (true) {
      ...
      if (!response || timeId_2>=latestTimestamp) {
        break;
      }
      timeId_1 = timeId_2;
