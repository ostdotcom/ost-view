...
const DEFAULT_DATA_FOR_ADDRESSES = {tokens_earned: 0, tokens_spent: 0, gas_spent: 0, total_transactions: 0, total_token_transfers: 0};
...
PopulateAddressDetail.prototype.process = function (blockNumber, startTransactionIndex) {
  ...
  // TODO:: check status of transactions as well create entry with 0 data
  // TODO:: transactions status column use enum
  // TODO:: check geth balance for 0 for OST PRIME
  // TODO: THROW WORKS and catch works on it
  // TODO: conversion rate of gas_used depending on the unit(wei or Gwei)
...
PopulateAddressDetail.prototype.processData = function (allTransactions, allTokenTransfers) {
  ...
  for (let transactionHashId in allTransactions) {
    ...
    if (txn.status !== 1 && tokenTransferTxns.length > 0) {
