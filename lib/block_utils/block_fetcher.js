...
BlockFetcher.prototype.formatBlockData = function (rawBlockData, chainId ,verifier) {
  ...
  formatedBlockData.push( block_attributes.indexOf("miner") > -1 ? rawBlockData.miner : null );
  formatedBlockData.push( block_attributes.indexOf("difficulty") > -1 ? rawBlockData.difficulty : null );
  formatedBlockData.push( block_attributes.indexOf("totalDifficulty") > -1 ? rawBlockData.totalDifficulty : null );
  formatedBlockData.push( block_attributes.indexOf("gasLimit") > -1 ? rawBlockData.gasLimit : null );
  formatedBlockData.push( block_attributes.indexOf("gasUsed") > -1 ? rawBlockData.gasUsed : null);
