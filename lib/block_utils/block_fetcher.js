...
/**
  * It fetch blocks from the node and feed them into the provided DB.
  * @module lib/block_utils/
  */
...
/**
 * @constructor
 * @description Constructor to create object of BlockFetcher
 * @param {Web3Object} Web3RPC Object
 * @param {Object} DB object to interact
 * @param {Boolean} verifier flag
 */
 ...
 * @param  {FunctionCallback} Insertion Complete Callback
 * @return {null}
 */
BlockFetcher.prototype.fetchAndUpdateBlock = function(blockNumber, insertionCompleteCallback) {
    ...
    oThis.web3Interact.isNodeConnected()
        ...
        .catch( function (err) { return oThis.errorHandling(err) } );
}
...
/**
 * To write Block Json Data object into the provided DB.
 * @param  {JSONObject} Block Data Json Object
 * @return {Promise}
 */
...
/**
 * To format block data as per the data sequence of insertion into DB.
 * @param  {JSONObject} Block Data Json Object
 * @param  {Boolean}    Verifier flag
 * @return {Array}
 */
...
/**
 * To format transaction data as per the data sequence of insertion into DB.
 * @param  {JSONObject} Transaction Data Json Object
 * @param  {JSONObject} Transaction Receipt Json Object
 * @param  {Integer}    timestamp of the block
 * @return {Array}
 */
...
/**
 * To format tokenTransaction data as per the data sequence of insertion into DB.
 * @param  {JSONObject} Transaction JSON object
 * @param  {Array} Decoded Contract Transactions List
 * @return {Array}
 */
