...
/**
 * @constructor 
 * @description Constructor to create object of BlockVerifier
...
/**
 * Method to verify block of blockNumber
 * First to check the verify flag from DB
 ...
 * @param  {FunctionCallback} verificationCompleteCallback verification compelete callback
 * @return {null}
 */
	...
	return new Promise((resolve,reject)=>{
		...
		oThis.deleteAllDataForBlock(blockNumber)
			.then(()=> {
				...
				blockFetcher.fetchAndUpdateBlock(blockNumber, (res)=>{
					resolve();
				});
			});
	});
