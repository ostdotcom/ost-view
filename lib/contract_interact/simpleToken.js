...
const rootPrefix = '../..'
  ...
  , web3RpcProvider = require(rootPrefix+'/lib/web3/providers/rpc_provider')
  , helper = require(rootPrefix+'/lib/contract_interact/helper')
  , coreAddresses = require(rootPrefix+'/config/core_addresses')
  , coreConstants = require(rootPrefix+'/config/core_constants')
  , responseHelper = require(rootPrefix+'/lib/formatter/response')
  , currContractAddr = coreAddresses.getAddressForContract(contractName)
  , valueRpcProvider = web3RpcProvider.getRPCproviderInstance(coreConstants.OSTE_GETH_VALUE_RPC_PROVIDER)
  , currContract = new valueRpcProvider.eth.Contract(coreAddresses.getAbiForContract(contractName))
;
...
const simpleTokenContractInteract = {
   ...
   */
    ...
    return helper.call(valueRpcProvider, currContractAddr, encodedABI, {}, ['uint256'])
