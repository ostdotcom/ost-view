  ...
  getBalance: function (address, contractAddress) {
    ...
    return new Promise(function (resolve, reject) {
      if (contractAddress != undefined && contractAddress.length > 1) {
        var token = new oThis.web3RpcProvider.eth.Contract(coreAbi.getInstance().getABI(), contractAddress);
...
const web3InteractHelper = (function () {
  ...
  function createInstance(webRpcURL) {    
    var object = new web3Interact(webRpcURL);
    return object;
  }
  ...
  return {
    ...
    getInstance: function (chainId) {
      if (!instances[chainId]) {
        instances[chainId] = createInstance(coreConfig.getWebRpcUrl(chainId));
      }
