...
const brandedToken = require('@openstfoundation/brandedtoken.js'),
  openSt = require('@openstfoundation/openst.js'),
...
abiDecoder.addABI(brandedTokenAbiBinProvider.getABI('UtilityBrandedToken'));
abiDecoder.addABI(openStAbiBinProvider.getABI('DelayedRecoveryModule'));
abiDecoder.addABI(openStAbiBinProvider.getABI('TokenHolder'));
abiDecoder.addABI(openStAbiBinProvider.getABI('GnosisSafe'));
abiDecoder.addABI(openStAbiBinProvider.getABI('TokenRules'));
abiDecoder.addABI(openStAbiBinProvider.getABI('PricerRule'));
