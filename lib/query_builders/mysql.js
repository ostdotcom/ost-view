 ...
 *
 ...
 var tableName = 'transaction_hashes';
 ...
 finalQuery == "SELECT transaction_hashes.*, transaction_hashes.*, `client_id`, `id`, `name`, sum(id) as total, created_at FROM `transaction_hashes` WHERE (id IN (1, 2) AND created_at > '2018-02-19') AND (symbol_icon IN ('ST1', 'ST2') AND symbol IS NULL) AND (symbol IS NULL) AND (name=\"ST1\") AND (`conversion_rate` IN (1, 2, 3) AND `symbol`='ST1') AND (`conversion_rate`=2) GROUP BY `id`, `token_uuid`, `symbol`, name, created_at, updated_at HAVING (MIN(`id`) < 20 and max(id) > 200) AND (MIN(`id`) < 10 and max(id) > 100) AND (SUM(`id`) < 10) AND (SUM(`id`) < 100) ORDER BY id ASC, client_id DESC, `name`, `reserve_managed_address_id`, `symbol`, `id` ASC, `client_id` DESC, `symbol` ASC LIMIT 20, 10";
 *
 *
 */
 ...
 *
 ...
 var finalQuery = printQuery(queryResponse.data.query, queryResponse.data.queryData);
 finalQuery == "UPDATE `transaction_hashes` SET name='ACMA', id=10, name='1', id=1000, `name`='CMA', `id`=0, `name`='MA', `id`=110, id=30, id=40 WHERE (id IN (1, 2) AND created_at > '2018-02-19') AND (symbol_icon IN ('ST1', 'ST2') AND symbol IS NULL) AND (symbol IS NULL) AND (name=\"ST1\") AND (`conversion_rate` IN (1, 2, 3) AND `symbol`='ST1') AND (`conversion_rate`=2) ORDER BY id ASC, client_id DESC, `name`, `reserve_managed_address_id`, `symbol`, `id` ASC, `client_id` DESC, `symbol` ASC LIMIT 10";
 ...
 var finalQuery = printQuery(queryResponse.data.query, queryResponse.data.queryData);
 finalQuery.includes("UPDATE `transaction_hashes` SET name='ACMA', id=10, name='1', id=1000, `name`='CMA', `id`=0, `name`='MA', `id`=110, id=30, id=40, updated_at='");
 *
 *
 */
 ...
 *
 ...
 var finalQuery = printQuery(queryResponse.data.query, queryResponse.data.queryData);
 finalQuery == "DELETE FROM `transaction_hashes` WHERE (id IN (1, 2) AND created_at > '2018-02-19') AND (symbol_icon IN ('ST1', 'ST2') AND symbol IS NULL) AND (symbol IS NULL) AND (name=\"ST1\") AND (`conversion_rate`=3 AND `symbol`='ST1') AND (`conversion_rate`=2) ORDER BY id ASC, client_id DESC, `name`, `reserve_managed_address_id`, `symbol`, `id` ASC, `client_id` DESC, `symbol` ASC LIMIT 10";
 ...
 finalQuery == "DELETE FROM `transaction_hashes` ORDER BY id ASC, client_id DESC, `name`, `reserve_managed_address_id`, `symbol`, `id` ASC, `client_id` DESC, `symbol` ASC LIMIT 10";
 *
 *
 */
 ...
 *
 ...
 var mysql = require('mysql');
 var dbName = 'saas_client_economy_sandbox_development';
 var tableName = 'transaction_hash';
 ...
 var finalQuery = printQuery(queryResponse.data.query, queryResponse.data.queryData);
 finalQuery == "INSERT INTO `transaction_hashes` (`name`, `age`) VALUES ('a', 21)";
 ...
 var finalQuery = printQuery(queryResponse.data.query, queryResponse.data.queryData);
 finalQuery == "INSERT INTO `transaction_hashes` (`name`, `age`) VALUES ('a', 21) ON DUPLICATE KEY UPDATE `name`='aman', `age`=25, name='a', age=100, id = 7, id2 = 74";

 var queryResponse = queryBuilder().insert({name: 'a', age: 21}).generate();
 var finalQuery = printQuery(queryResponse.data.query, queryResponse.data.queryData);
 finalQuery.includes("INSERT INTO `transaction_hashes` (`name`, `age`, `updated_at`, `created_at`) VALUES ('a', 21, '");

 var queryResponse = queryBuilder().insert({name: 'a', age: 21, created_at: '2018-01-01 00:00:00'}).generate();
 var finalQuery = printQuery(queryResponse.data.query, queryResponse.data.queryData);
 finalQuery.includes("INSERT INTO `transaction_hashes` (`name`, `age`, `created_at`, `updated_at`) VALUES ('a', 21, '2018-01-01 00:00:00', '");
 ...
 var finalQuery = printQuery(queryResponse.data.query, queryResponse.data.queryData);
 finalQuery.includes("INSERT INTO `transaction_hashes` (`name`, `age`, `created_at`, `updated_at`) VALUES ('a', 21, '2018-01-01 00:00:00', '2018-01-02 00:00:00')");
 *
 */
 ...
 *
 ...
 var finalQuery = printQuery(queryResponse.data.query, queryResponse.data.queryData);
 finalQuery == "INSERT INTO `transaction_hashes` (`name`, `age`) VALUES ('a', 21), ('b', 22)";

 var queryResponse = queryBuilder().insertMultiple(['name', 'age'], [['a', 21], ['b', 22]], {touch: false, insertWithIgnore: true}).generate();
 var finalQuery = printQuery(queryResponse.data.query, queryResponse.data.queryData);
 finalQuery == "INSERT IGNORE INTO `transaction_hashes` (`name`, `age`) VALUES ('a', 21), ('b', 22)";
 ...
 var finalQuery = printQuery(queryResponse.data.query, queryResponse.data.queryData);
 finalQuery == "INSERT INTO `transaction_hashes` (`name`, `age`) VALUES ('a', 21), ('b', 22) ON DUPLICATE KEY UPDATE `name`='aman', `age`=25, name='a', age=100, id = 7, id2 = 74";
 ...
 var finalQuery = printQuery(queryResponse.data.query, queryResponse.data.queryData);
 finalQuery.includes("INSERT INTO `transaction_hashes` (`name`, `age`, `created_at`, `updated_at`) VALUES ('a', 21, '2018-01-01 00:00:00', '2018-01-02 00:00:00'), ('b', 22, '2018-01-01 10:00:00', '2018-01-02 10:00:00')");
 *
 */
...
MySQLQueryBuilderKlass.prototype = {
   ...
   * insert({name: 'ACMA', id: 10}, {insertWithIgnore: true, touch: false})
   *
   ...
   * @param (object) [insertOptions.insertWithIgnore] - if true, INSERT with Ignore . Default is false.
   *
   * @return {object<self>} oThis
   */
   ...
   * insertMultiple(['name', 'symbol'], [['ABC', '123'], ['ABD', '456']], {insertWithIgnore: true, touch: false})
   *
  ...
  insertMultiple: function (insertColumnConst, insertValues, insertOptions) {
    ...
    if (oThis.insertWithIgnore !== true) {
      oThis.insertWithIgnore = ((insertOptions || {}).insertWithIgnore===true ? true : false);
    }
  ...
  _generateInsert: function () {
    ...
    if (oThis.insertWithIgnore) {
      if (oThis.onDuplicateSubQueries.length > 0) {
        throw "INSERT IGNORE cannot be called with on duplicate condition";
      }
      queryString += " IGNORE";
    }
