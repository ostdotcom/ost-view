...
DbHelper.prototype = {
  ...
  getAddressesWithBrandedToken: function(brandedTokenId){
    return this.dbObject.selectAddressesWithBrandedToken(brandedTokenId);
  }
  ...
  , getRecentTokenTransactions: function(pageNumebr, pageSize){
    return this.dbObject.selectRecentTokenTransactions(pageNumebr, pageSize);

  }

  ,getTopTokens : function(pageNumebr, pageSize){
    return this.dbObject.selectTopTokens(pageNumebr, pageSize);
  }
