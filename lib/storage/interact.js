...
DbHelper.prototype = {
  ...
  getContractLedger: function (contractAddress, pageSize, pagePayload) {
    ...
    return this.dbObject.selectContractLedger(contractAddress, pageSize, pagePayload);
  },
  ...
  getBlockTransactionsFromBlockNumber: function (blockNumber, pageSize, pagePaylaod) {
    ...
    return this.dbObject.getBlockTransactionsFromBlockNumber(blockNumber, pageSize, pagePaylaod);
  },
  ...
  getAddressTokenTransactions: function (address, pageSize, pagePaylaod) {
    ...
    return this.dbObject.selectAddressTransactions(constants.ADDRESS_TOKEN_TRANSACTION_TABLE_NAME, address, pageSize, pagePaylaod);
  },
  ...
  getAddressesWithBrandedToken: function(brandedTokenId, PageSize, pagePaylaod){
    return this.dbObject.selectAddressesWithBrandedTokenId(brandedTokenId, PageSize, pagePaylaod);
  },
  getRecentTokenTransactions: function(pageSize, pagePaylaod){
    return this.dbObject.selectRecentTokenTransactions(pageSize, pagePaylaod);

  },

  getTopTokens : function(pageSize, pagePayload) {
    return this.dbObject.selectTopTokens(pageSize, pagePayload);
  },
