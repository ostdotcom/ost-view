...
DbHelper.prototype = {
   ...
   */
  getGraphDataForBrandedTokenTransactionsByType:function(brandedTokenId){
    return this.dbObject.getGraphDataForBrandedTokenTransactionsByType(brandedTokenId);
  },
