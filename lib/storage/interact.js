...
DbHelper.prototype = {
  ...
  getTransactionType: function (transactionsHashes) {
    ...
    return new Promise(function(resolve){
      var array = [];
      transactionsHashes.forEach(function(hash) {
          var obj = {};
          obj.transaction_hash=hash;
  ...
  numberOfRowsInBrandedTokenTable: function() {
    this.dbObject.selectBrandedTokenDetails()
  ...
  getGraphDataForBrandedTokenTransactionsByType:function(contractAddress){
    return this.dbObject.getGraphDataForBrandedTokenTransactionsByType(contractAddress);
  },

  /**
   * Get transaction number in given contract address
   * @param {Integer} contractAddress - contract address
   */
  getGraphDataOfNumberOfBrandedTokenTransactions: function(contractAddress){
    return this.dbObject.getGraphDataOfNumberOfBrandedTokenTransactions(contractAddress);
  },
  ...
  getBrandedTokenTopUsers: function(contractAddress){
    return this.dbObject.getBrandedTokenTopUsers(contractAddress);
  },
  ...
  getOstSupply: function(contractAddress){
    return this.dbObject.getOstSupply(contractAddress);
  }
