...
DbHelper.prototype = {
  ...
  getGraphDataForContractValueOfTransactions: function(contractAddress, duration){
    return this.dbObject.getGraphDataForContractValueOfTransactions(contractAddress, duration);
  },
  ...
  getGraphDataForContractTransactionsByType:function(contractAddress, duration){
    return this.dbObject.getGraphDataForContractTransactionsByType(contractAddress, duration);
  },
  ...
  getGraphDataForContractNoOfTransactions: function(contractAddress, duration){
    return this.dbObject.getGraphDataForContractNoOfTransactions(contractAddress, duration);
  },
  ...
  getTopUsers: function(contractAddress){
    return this.dbObject.getTopUsers(contractAddress);
  },
