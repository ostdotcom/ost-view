...
DbHelper.prototype = {
  ...
  getLastInsertedTimeId: function () {
    return this.dbObject.selectLastInsertedTimeStamp();
  },
    ...
    return new Promise(function(resolve, reject){
        oThis.dbObject.selectLowestUnVerifiedBlockNumber()
            .then(function( blockNumber ){
                oThis.dbObject.selectBlock(blockNumber)
                    .then(function( block ){
   ...
   * @param contractId - Contract Id of the company
   * @param timeId1 - left bound of timestamp
   * @param timeId2 - right bound of timestamp
   */
   ...
   */
  getTotalTokenHolders: function(contractTokenId) {
    return this.dbObject.selectTotalTokenHolders(contractTokenId);
  }
};
