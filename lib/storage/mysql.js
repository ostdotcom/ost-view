...
MySQL.prototype = {
  ...
  selectCoinFromContractAddress: function (contractAddress) {
    ...
    var query = "SELECT company_name,contract_address,company_symbol,price,token_holders,market_cap,circulation,total_supply,uuid, creation_time from " + constants.BRANDED_TOKEN_TABLE_NAME + " WHERE contract_address=?";
    return new Promise(function (resolve, reject) {
      try {
