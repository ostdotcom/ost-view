...
MySQL.prototype = {
  ...
  selectTopTokens: function (pageSize, pagePayload) {
    ...
    var query = "SELECT id, company_name, contract_address, company_symbol, price, market_cap, circulation, token_ost_volume from " + constants.BRANDED_TOKEN_TABLE_NAME + " where id != ? ";
